...
def run_hypothesis_test(rng, null_mean, population_sd, sample_size, alpha):
...
def run_repetitions(rng, null_mean, population_sd, sample_size, alpha, repetitions):
    z_stats = []
    p_values = []
    decisions = []

    for _ in range(repetitions):
        z_stat, p_value, decision = run_hypothesis_test(rng, null_mean, population_sd, sample_size, alpha)
...
def main():
    ...
    z_stats, p_values, decisions = run_repetitions(rng, null_mean, population_sd, sample_size, alpha, repetitions)
    ...
    alpha_level_validations = {}
    for alpha_level, rate in p_below_alpha_rates.items():
        alpha_level_validations[alpha_level] = validate_error_rate(alpha_level, rate, tolerance)
